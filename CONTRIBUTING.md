# Contributing to AumAI Modality
...
### Setup
```bash
git clone https://github.com/aumai/aumai-modality.git
cd aumai-modality
python -m venv .venv
...
### Good First Issues
New to the project? Start with issues labeled [`good first issue`](https://github.com/aumai/aumai-modality/labels/good%20first%20issue).
...
- [GitHub Discussions](https://github.com/aumai/aumai-modality/discussions)
